package modid.utils.clock

import modid.utils.profile
...
open class Executor(
    val delay: () -> Long,
    private val profileName: String = "Unspecified NoobRoutes executor",
    ...
    constructor(
        delay: Long,
        profileName: String = "Unspecified NoobRoutes executor",
