...
public abstract class MixinEntityLivingBase {
    ...
    private void modid$onMoveEntityWithHeadingPre(float strafe, float forward, CallbackInfo ci) {
    ...
    private void modid$onMoveEntityWithHeadingPost(float strafe, float forward, CallbackInfo ci) {
        if ((Object) this instanceof EntityPlayerSP) {
